...
const TopBrands = () => {
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      try {
        const res = await fetch(getApiUrl('get-featured-brands.php'));
  ...
  return (
    <div className="top-br-wrapper">
      <div className="top-br-heading-row">
        <h2 className="top-br-heading">Trending Franchising Opportunities</h2>
        <a href="/trending-brands" className="top-br-view-all">View All</a>
      </div>
          ...
          <div className="top-br-card" key={brand.id || i}>
            ...
            <div className="top-br-info">
              ...
              <div className="top-br-details">
                <p><span>Investment</span><span>₹{brand.investment_required || 'N/A'}</span></p>
